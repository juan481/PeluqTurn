...
<body>
    ...
    <main> 
        <div class="registration-form">
            <form>
                ...
                <h4 class="text">Datos de local</h4>
                ...
                <div class="form-group text-center">
                    <button type="button" class="btn btn-block create-account">Enviar actualización</button>
                </div>
    ...
    <footer class="fixed-bottom bg-light">
        <nav class="nav nav-pills nav-justified">
            <a class="nav-item nav-link" href="b_turnos.html"><i class="bi bi-ticket-perforated fs-2"></i></i></a>
            <a class="nav-item nav-link active" href="b_locales.html"><i class="bi bi-shop fs-2 "></i></a>
